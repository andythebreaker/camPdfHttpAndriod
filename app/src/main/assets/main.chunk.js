...
/* harmony import */ var react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_3__);
        ...
        const generatePdfFromImages = images => {
          ...
          callAjax("/book_list_file_name.json", (stuffback) => {
            console.log(stuffback);

            //var stuffback = `["filename1.jpg","filename1.jpg","filename1.jpg"]`;
            var imgs_ary_obj = JSON.parse(stuffback);
            console.log(imgs_ary_obj.length);
            var int_img_pre_pors_fin=0;
            for (let imgs_ary_objindex = 0; imgs_ary_objindex < imgs_ary_obj.length; imgs_ary_objindex++) {
              ...
              fetch("/bookpage/"+imgs_ary_objelement)
                .then(function (response) {
                  return response.blob()
                })
                .then(function (blob_then) {
                                  console.log(blob_then);

                  // here the image is a blob
                  console.log("success");
                                      var my_success = URL.createObjectURL(blob_then);
...
function generatePdfFromImages_onClick(event) {
  console.log(event);
}
